...
//void Copter::GetModel(void)
//{
//	Copter_UT496();
//}


//void Copter::Copter_UT496(void)
//{
//	/* read config files */
//	mass = 915;
//	omega = 525 * PI / 30;
...
//
//	vel_c[0] = vel_c[1] = vel_c[2] = 0, omg_c[0] = omg_c[1] = omg_c[2] = 0;
//	dvel_c[0] = dvel_c[1] = dvel_c[2] = 0, domg_c[0] = domg_c[1] = domg_c[2] = 0;
//	vel_g[0] = vel_g[1] = vel_g[2] = 0, omg_g[0] = omg_g[1] = omg_g[2] = 0;
//	dvel_g[0] = dvel_g[1] = dvel_g[2] = 0, domg_g[0] = domg_g[1] = domg_g[2] = 0;
//	airforce_sigma[0] = airforce_sigma[1] = airforce_sigma[2] = 0;
//	airmoment_sigma[0] = airmoment_sigma[1] = airmoment_sigma[2] = 0;
//	
